...
import com.yanxiuhair.framework.shiro.util.AuthorizationUtils;
...
public class SysMenuController extends BaseController {
	 ...
	 * 选择菜单树--代码生成使用
	 */
	@GetMapping("/selectMenuTree2/{menuId}")
	public String selectMenuTree2(@PathVariable("menuId") Long menuId, ModelMap mmap) {
		mmap.put("menu", menuService.selectMenuById(menuId));
		return prefix + "/tree2";
	}
}