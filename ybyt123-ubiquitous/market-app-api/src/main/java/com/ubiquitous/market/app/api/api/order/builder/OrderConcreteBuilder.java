...
import com.ubiquitous.market.app.api.api.category.CategoryService;
import com.ubiquitous.market.app.api.api.order.OrderServiceImpl;
import com.ubiquitous.market.biz.service.freight.FreightBizService;
import com.ubiquitous.market.biz.service.groupshop.GroupShopBizService;
import com.ubiquitous.market.biz.service.orderobserve.OrderObserveAble;
import com.ubiquitous.market.biz.service.orderobserve.OrderUpdater;
...
import com.ubiquitous.market.data.mapper.CartMapper;
...
import com.ubiquitous.market.data.mapper.UserCouponMapper;
...
public class OrderConcreteBuilder extends OrderBuilder {
    ...
    @Value("${com.ubiquitous.market.machine-no}")
    private String MACHINE_NO;

    @Value("${com.ubiquitous.market.env}")
    private String ENV;
