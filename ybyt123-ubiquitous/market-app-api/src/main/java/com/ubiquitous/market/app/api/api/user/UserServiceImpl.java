package com.ubiquitous.market.app.api.api.user;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.mapper.EntityWrapper;
import com.ubiquitous.market.biz.service.activity.ActivityBizService;
import com.ubiquitous.market.biz.service.user.UserBizService;
...
import com.ubiquitous.market.core.notify.SmsbaoSMSClient;
import com.ubiquitous.market.core.util.GeneratorUtil;
import com.ubiquitous.market.core.util.SHAUtil;
import com.ubiquitous.market.core.util.WxUtil;
...
public class UserServiceImpl implements UserService {
    ...
    @Value("${com.ubiquitous.market.wx.mini.app-secret}")
    private String wxMiNiSecret;

    @Value("${com.ubiquitous.market.wx.app.app-id}")
    private String wxAppAppid;

    @Value("${com.ubiquitous.market.wx.app.app-secret}")
    private String wxAppSecret;

    @Value("${com.ubiquitous.market.wx.h5.app-id}")
    private String wxH5Appid;

    @Value("${com.ubiquitous.market.wx.h5.app-secret}")
