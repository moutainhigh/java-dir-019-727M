package com.ubiquitous.market.rider.manager;
...
public class ApiManager implements InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        Reflections reflections = new Reflections(new ConfigurationBuilder().forPackages("com.ubiquitous").addScanners(new SubTypesScanner()).addScanners(new FieldAnnotationsScanner()));
        ...
        for (String gpKey : gpKeys) {
            ...
            for (String methodNameKey : methodNameKeys) {
                ...
                if (httpMethod != null) {
                    ...
                    if (retType.startsWith("com.ubiquitous")) {
                        //若返回值类型为复杂类型
