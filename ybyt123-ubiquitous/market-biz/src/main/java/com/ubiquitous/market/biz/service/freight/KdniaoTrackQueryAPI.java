...
import com.ubiquitous.market.data.dto.freight.ShipTraceItemDTO;
import com.ubiquitous.market.data.enums.ShipCodeType;
...
public class KdniaoTrackQueryAPI implements ShipTraceQuery {
    ...
    @Value("${com.ubiquitous.ship.query.kdn.app-key}")
    private String businessID;

    @Value("${com.ubiquitous.ship.query.kdn.business-id}")
