package com.ubiquitous.market.plugin.core.manager;

import com.ubiquitous.market.plugin.core.inter.AbstractPlugin;
...
public class PluginsManager {
    ...
    public void registerPlugin(AbstractPlugin plugin) {
        ...
        for (Class clazz : interfaces) {
            ...
            if (name.startsWith("com.ubiquitous.market.plugin.core.inter")) {
