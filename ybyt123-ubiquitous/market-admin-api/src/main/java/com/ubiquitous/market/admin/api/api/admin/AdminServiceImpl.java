package com.ubiquitous.market.admin.api.api.admin;
...
import com.ubiquitous.market.core.exception.ThirdPartServiceException;
import com.ubiquitous.market.core.notify.SMSClient;
import com.ubiquitous.market.core.notify.SMSResult;
import com.ubiquitous.market.core.util.GeneratorUtil;
import com.ubiquitous.market.core.util.MD5Util;
import com.ubiquitous.market.core.util.SHAUtil;
import com.ubiquitous.market.data.component.CacheComponent;
import com.ubiquitous.market.data.domain.AdminDO;
import com.ubiquitous.market.data.domain.RoleDO;
import com.ubiquitous.market.data.domain.RolePermissionDO;
import com.ubiquitous.market.data.dto.AdminDTO;
import com.ubiquitous.market.data.enums.AdminStatusType;
import com.ubiquitous.market.data.enums.RoleStatusType;
import com.ubiquitous.market.data.mapper.AdminMapper;
import com.ubiquitous.market.data.mapper.RoleMapper;
import com.ubiquitous.market.data.mapper.RolePermissionMapper;
import com.ubiquitous.market.data.model.Page;
import com.ubiquitous.market.data.util.SessionUtil;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Value("${com.ubiquitous.admin.notify.uninotify.url}")
    private String uniNotifyUrl;

    @Value("${com.ubiquitous.admin.notify.uninotify.app-secret}")
    private String uniNotifyAppSecret;

    @Value("${com.ubiquitous.admin.notify.uninotify.app-id}")
