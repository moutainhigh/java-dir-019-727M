...
public class CommectFriendActivity extends Activity implements View.OnFocusChangeListener {
    private EditText mEditText;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.commentmyfriendxml);
        mEditText = findViewById(R.id.comment_friend_title);
