...
public class OwnParticipateInActivitiesAdapt extends BaseExpandableListAdapter {
    public static final int TYPE_LEVEL_0 = 0;
    public static final int TYPE_LEVEL_1 = 1;
    private List<OwnParticipateInActivities.TitleInfo> list;
    private Context         mContext;

    public OwnParticipateInActivitiesAdapt(List<OwnParticipateInActivities.TitleInfo> list, Context context) {
        this.list = list;
        mContext = context;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        OwnParticipateInActivities.ContentInfo contentInfo = list.get(groupPosition).getInfo().get(childPosition);
