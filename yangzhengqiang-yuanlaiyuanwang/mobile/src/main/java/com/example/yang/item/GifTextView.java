...
import com.example.yang.util.ScreenUtil;
import com.example.yang.util.FaceData;
import com.example.yang.util.GifOpenHelper;
...
public class GifTextView extends android.support.v7.widget.AppCompatEditText {
    /**
