...
import com.example.yang.richeditor.model.IBlockImageSpanObtainObject;
import com.example.yang.richeditor.model.IInlineImageSpanObtainObject;
...
import com.example.yang.richeditor.span.BoldStyleSpan;
import com.example.yang.richeditor.span.CustomQuoteSpan;
import com.example.yang.richeditor.span.CustomStrikeThroughSpan;
import com.example.yang.richeditor.span.CustomUnderlineSpan;
import com.example.yang.richeditor.span.HeadlineSpan;
import com.example.yang.richeditor.span.IBlockSpan;
import com.example.yang.richeditor.span.IInlineSpan;
import com.example.yang.richeditor.span.InlineImageSpan;
import com.example.yang.richeditor.span.ItalicStyleSpan;
import com.example.yang.richeditor.utils.SoftKeyboardUtil;
    ...
    List<RichEditorBlock> getContent() {
        ...
        for (int i = 0; i < enterCharSize; i++) {
            ...
            if (blockImageSpans.length > 0) {
                ...
                blockImageSpan.getBlockImageSpanVm();
