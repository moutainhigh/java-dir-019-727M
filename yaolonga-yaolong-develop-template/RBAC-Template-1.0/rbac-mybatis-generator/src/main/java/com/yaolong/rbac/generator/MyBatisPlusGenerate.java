...
public class MyBatisPlusGenerate {
	 ...
	 * JDBC 连接地址
	 */
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/study?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
	 ...
	 * 包配置 - 控制器目录
	 */
	private static final String PACKAGE_CONTROLLER = "controller.vue3VbenAdmin";
...
//	private static final String TABLES = "study_user_role,study_role_permission,study_role_menu_resource,study_role,study_permission,study_meun_resource";
	private static final String TABLES = "study_role_menu_resource_vben";
