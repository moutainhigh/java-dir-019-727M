package com.yaolong.rbac.commons.response;
...
public enum ResponseCode {
	 ...
	 * 旧密码错误
	 */
	USER_OLD_PASSWORD_ERROR(20013, "旧密码错误"),

	/**
	 * 新密码和旧密码一致
	 */
	USER_NEW_AND_OLD_PASSWORD_UNANIMOUS_ERROR(20014, "新密码和旧密码一致"),
	 ...
	 * 压缩包类型错误
	 */
	ARCHIVE_IS_WRONG(50005, "仅支持 tar gz zip jar 类型的压缩包"),

	/**
	 * 视频类型错误
	 */
	VIDEO_IS_WRONG(50006, "仅支持 video mpeg mp4 3gpp mpg 类型的视频"),


	/**
	 * 数据过大
	 */
	DATA_IS_LARGE(50007, "数据过大"),


	/**
	 * 文件为空
	 */
	FILE_IS_Null(50008, "上传文件为空"),

	/**
	 * 文件上传失败
	 */
	FILE_UPLOAD_FAIL(50008, "文件上传失败"),

	/**
	 * 文件删除失败
	 */
	FILE_DELETE_FAIL(50009, "文件删除失败"),

	/**
	 * 文件不存在
	 */
	FILE_NOT_EXIST(500010, "文件不存在"),
	...
	PERMISSION_NO_TOKEN(70002, "无效token");
