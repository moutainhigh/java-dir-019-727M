...
import {
  createPermissionCate,
  deletePermissionCateById,
  getPermissionCate,
  updatePermissionCate
} from '@/api/auth/permission-category'
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$confirm('是否要删除该分类?', '提示', {
        ...
        deletePermissionCateById(row.id).then(response => {
          this.$message({
            type: 'success',
            message: '删除成功!'
          })
    ...
    handleDialogConfirm() {
      this.$confirm('是否要确认?', '提示', {
        ...
        if (this.isEdit) {
          updatePermissionCate(this.resourceCategory).then(response => {
            this.$message({
              message: '修改成功！',
              type: 'success'
            })
          ...
          createPermissionCate(this.resourceCategory).then(response => {
            this.$message({
              message: '添加成功！',
              type: 'success'
            })
