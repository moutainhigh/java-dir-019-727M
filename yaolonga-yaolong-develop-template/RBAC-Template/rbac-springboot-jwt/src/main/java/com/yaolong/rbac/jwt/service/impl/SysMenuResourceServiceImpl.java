...
import com.yaolong.rbac.jwt.dto.elementAdmin.MenuResourceDto;
...
public class SysMenuResourceServiceImpl extends BaseServiceImpl<SysMenuResourceMapper, SysMenuResource> implements ISysMenuResourceService {
    ...
    @Resource
    public ISysRoleMenuResourceService sysRoleMenuResourceService;
    ...
    public boolean remove(Long id) {
        if (checkId(id)){
            ...
            sysRoleMenuResourceService.remove(queryWrapper);
