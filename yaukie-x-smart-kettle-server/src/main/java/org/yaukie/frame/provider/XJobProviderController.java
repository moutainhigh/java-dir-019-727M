...
**/
@RestController
@RequestMapping(value = "/provider/job")
@Api(value = "免鉴权作业调度接口控制器", description = "\"免鉴权作业调度接口控制器\"")
@Slf4j
public class XJobProviderController extends BaseController {
