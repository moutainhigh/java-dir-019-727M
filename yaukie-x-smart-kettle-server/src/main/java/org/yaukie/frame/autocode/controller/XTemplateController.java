...
//            log.info("模板路径，{}",rootPath);
            ...
            org.springframework.core.io.Resource resource = resourceLoader.getResource("classpath:/" + xTemplate.getTemplatePath());
            JobMeta jobMeta = new JobMeta(resource.getInputStream(), null,null) ;
